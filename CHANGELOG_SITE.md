...
| 15 | Enable RLS on Supabase for product and order tables | Avoid security breaches from exposing anon key in browser with write privileges | <span style="color:#cf222e;">❌ Not completed</span>| 2026-01-24 | @tanner | none |
| 16 | CMS Prototype | Build and deploy Phase I prototype of the CMS - focused on administrator functions | <span style="color:#2da44e;">✅</span>| 2026-01-25 | @pat | none |
| 17 | Consolidated Actions Site | Build and deploy a single cite with actions and plans from across Cypress sites (https://cypress-resort-actions.vercel.app/) | <span style="color:#2da44e;">✅</span>| 2026-01-25 | @pat | none |
